...
var Date_ = /** @class */function () {
    function Date_(param) {
        ...
        // 以字符串初始化指定日期，例如 `2022/05/26`
            ...
            // 以分别指定的指定年、月、日的形式初始化
            else if (typeof param[0] === "number" && typeof param[1] === "number" && typeof param[2] === "number" && param.length === 3) {
                    this._year = param[0];
                    this._month = param[1];
                    this._day = param[2];
                    this._d_check();
