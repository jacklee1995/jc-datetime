...
class Hour {
     ...
     */
    print():void{
        let temp = this._value.toString() + ":" + this.minute.value.toString() + ":" + this.minute.seconds.toString();
        console.log(temp);
    }
...
class Date_ {
    ...
    /**打印日期字符串 */
    print():string{
        let temp = this.year.toString() + "/" + this._month.toString() + "/" + this._day.toString();
        console.log(temp);
        return temp
    }
}
