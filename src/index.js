...
var StaticFuncs = /** @class */ (function () {
    ...
    StaticFuncs.datelist = function (date_begin, date_end) {
        ...
        var date_list = new container_1.List(); // 日期容器
...
var Hour = /** @class */ (function () {
    ...
    Object.defineProperty(Hour.prototype, "last", {
         ...
         */
        get: function () {
            var h = new Hour([this._value, this._minute.minutes, this._minute.seconds]);
            h.to_last();
            return h;
        },
        enumerable: false,
...
var Date_ = /** @class */ (function () {
    ...
    Date_.prototype.to_next = function () {
        var days = StaticFuncs.get_days(this.year.toString() + "/" + this.month.toString());
        if (this.day < days) {
    ...
    Date_.prototype.print = function () {
        var temp = this.year.toString() + "/" + (0, tools_1.zeroFill)(this._month) + "/" + (0, tools_1.zeroFill)(this._day);
        console.log(temp);
    };
        ...
        get: function () {
            ...
            // this.day === 1
                ...
                if (this.month != 1) {
                    ...
                    return new Date_([parseInt(last_year), parseInt(last_month), parseInt(last_day_7)]);
                }
                // this.month === 1
                else {
                    var last_month = "12";
                    ...
                    return new Date_([parseInt(last_year), parseInt(last_month), parseInt(last_day_8)]);
                }
            }
        },
        enumerable: false,
